...
ActiveRecord::Schema.define(version: 20170505131901) do
  ...
  create_table "activity_lines_corporative_merits", force: :cascade do |t|
    t.integer  "user_id"
    t.text     "nomination"
    t.integer  "year"
    t.datetime "created_at", null: false
  ...
  create_table "activity_lines_lider_ya_lider_event_fields", force: :cascade do |t|
    t.text     "field_type"
    t.text     "value"
    t.integer  "event_id"
    t.text     "title"
  ...
  create_table "activity_lines_lider_ya_lider_participant_events", force: :cascade do |t|
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.text     "comment_type", default: "user"
  end
  ...
  create_table "delivery_campaign_tests", force: :cascade do |t|
    t.integer  "campaign_id"
